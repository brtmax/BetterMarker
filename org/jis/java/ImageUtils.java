...
public final class ImageUtils {
   ...
   * @throws IllegalArgumentException iff width or height are not suitable
   */
  public static BufferedImage scaleAndCrop(BufferedImage input, int width, int height) {
    ...
    BufferedImage scaled = factorX > factorY //
        ? scaleWidth(input, width) : scaleHeight(input, height);
   ...
   * @param width the target width
   * @return scaled image
   * @throws IllegalArgumentException iff width or height are not suitable (given or calculated)
   */
